<template>
  <a-card :bordered="false">
    ...
    <!-- 创建路由信息表单-->
    <goods-attr-group-form ref="goodsAttrTemplateForm"
...
import {getInfo, getPageList} from '@/api/product/attr-group-api'
import GoodsAttrGroupForm from "./components/GoodsAttrGroupForm";
...
export default {
  ...
  methods: {
    ...
    showForm() {
      this.$refs['goodsAttrTemplateForm'].open({attrTemplateId: this.queryParam.attrTemplateId}, 'add')
    },
    rowKey(record) {
      return record.id
    },
