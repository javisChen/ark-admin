<template>
  <a-card :bordered="false">
    ...
    <!-- 创建路由信息表单-->
    <goods-attr-template-form ref="goodsAttrTemplateForm"
    ...
    <a-modal v-if="selectedAttrTemplate"
      ...
      <goods-attr-group :attr-template-id="selectedAttrTemplate.id"/>
    </a-modal>
    ...
    <a-modal v-if="selectedAttrTemplate"
      ...
      <goods-attr :attr-template-id="selectedAttrTemplate.id" :type="attrType"/>
    </a-modal>
...
import {getInfo, getPageList} from '@/api/product/attr-template-api'
import GoodsAttrTemplateForm from "./components/GoodsAttrTemplateForm";
import GoodsAttrGroup from "../attrGroup/GoodsAttrGroup";
import GoodsAttr from "../attr/GoodsAttr";
...
export default {
  name: 'GoodsAttrTemplate',
  components: {
    GoodsAttrTemplateForm,
    GoodsAttrGroup,
    GoodsAttr
  },
  data() {
  ...
  methods: {
    ...
    showForm() {
      this.$refs['goodsAttrTemplateForm'].open()
    },
    rowKey(record) {
      return record.id
    },
