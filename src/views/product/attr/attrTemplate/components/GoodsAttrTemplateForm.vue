<template>
  ...
  <a-modal
    ...
    <a-form-model
      ...
      <a-form-model-item ref="name" label="模板名称" prop="name" has-feedback>
        <a-input placeholder="模板名称" v-model="formModel.name"/>
      </a-form-model-item>
...
import {save} from '@/api/product/attr-template-api'
