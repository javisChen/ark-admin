  ...
  <a-modal
    ...
    <a-form-model
      ...
      <a-form-model-item ref="attrGroupId" label="属性组" prop="attrGroupId">
        <goods-attr-group-select v-if="formModel.attrTemplateId"
                                     :attrTemplateId="formModel.attrTemplateId"
                                     v-model="formModel.attrGroupId"></goods-attr-group-select>
      </a-form-model-item>
...
import {save as saveAttr} from '@/api/product/attr-api'
import GoodsAttrGroupSelect from "../../attrGroup/components/GoodsAttrGroupSelect";
