...
<script>
import {getPageList as getAttrGroupList} from '@/api/product/attr-group-api'
...
export default {
  ...
  watch: {
    ...
    formModel(newV, oldV) {
      ...
      // 回显初始化
      if (this.internalModel.params && this.internalModel.params.length > 0) {
        this.internalModel.params.forEach(item => {
