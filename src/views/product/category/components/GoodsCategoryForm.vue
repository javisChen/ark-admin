  ...
  <a-modal
    ...
    <a-form-model
      ...
      <a-form-model-item ref="attrTemplateId" label="商品属性模板" prop="isNav">
        <goods-attr-template-select v-model="formModel.attrTemplateId"/>
      </a-form-model-item>
...
import {save, getInfo} from '@/api/product/category-api';
import GoodsAttrTemplateSelect from "@/views/product/attr/attrTemplate/components/GoodsAttrTemplateSelect";
